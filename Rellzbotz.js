...
const startImageUrl = 'https://o.uguu.se/lMoKKjKt.jpg';
const panelImageUrl = 'https://files.catbox.moe/fc8d1h.jpg';
const ownerImageUrl = 'https://d.uguu.se/vcbfzwFH.jpg';
const fiturImageUrl = 'https://o.uguu.se/TMMzQxxp.jpg';
const cekIdImageUrl = 'https://o.uguu.se/lMoKKjKt.jpg';
const groupUrl = 'https://t.me/+_Gu4OEtSmos2MTBl'; // URL grup Telegram
const chanelUrl = 'https://t.me/Tsunebanido'; // Url chanel Telegram
const panelUrl = 'https://files.catbox.moe/fc8d1h.jpg' // Set Url Data Panel

// Fungsi untuk menampilkan menu start
const sendStartMenu = (chatId, messageId, username) => {
    const caption = `Hai ${username} \n〤 I am Zyy bot via Telegram, created by @ZyyTsune Silent. Enjoy using the bot. Thank You.\n\n〤 Silakan pilih menu di bawah ini 😉:`;
...
bot.onText(/\/start/, (msg) => {
    ...
    bot.sendPhoto(chatId, startImageUrl, {
        caption: `Hai ${username} \n〤 I am Rellz botz create panel via Telegram, created by @ZyyTsune Silent. Enjoy using the bot. Thank You.\n\n〤 Silakan pilih menu di bawah ini 😉:`,
        reply_markup: {
            inline_keyboard: [
                [
                    { text: 'Panel Menu', callback_data: 'panel_menu' },
  ...
  if (!isAdmin) {
    bot.sendMessage(
      ...
      "Fitur Khusus Owner!",
      {
        reply_markup: {
          inline_keyboard: [
            [{ text: "HUBUNGI ADMIN", url: "https://t.me/ZyyTsune" }],
          ],
        },
      }
    );
...
📍 ᴄᴀᴛᴀᴛᴀɴ ᴘᴇɴᴛɪɴɢ:
    ...
    3. NAMA BELAKANG EMAIL HARUS  @ZyyTsune JANGAN @gmail.com ATAU YANG LAINNYA
    4. JANGAN RUSUH
    5. IKUTI ATURAN
    `
    );
...
console.log(chalk.yellow.bold('bot Zyy v1.0 berhasil tersambung!!'));
console.log(' ');
console.log(' ');
console.log(chalk.blue.bold('Contact Dev:'));
console.log(chalk.yellow.bold('WhatsApp: +628819909465'));
console.log(chalk.yellow.bold('Telegram: @zeeLS7'));
